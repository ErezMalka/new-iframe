...
export class ScratchCouponComponent implements OnInit {
  ...
  public nextTime() {
    this.appStorageService.useScratchCoupon = false; // Not to use in order
    this.appStorageService.isUsedScratchCoupon = false;
    this.appStorageService.wasScratchDisplayed = true;
    this.dialogRef.close(false);
  }

  public use() {
    this.appStorageService.useScratchCoupon = true; // To use in order
    this.appStorageService.isUsedScratchCoupon = false;
    this.appStorageService.wasScratchDisplayed = true;
